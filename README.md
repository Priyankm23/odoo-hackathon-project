...
```bash
odoo-project/
├── hackathon-backend/              # Node.js + Express Backend
│   ├── config/
...
│   │   ├── redeemController.js    # Point redemption
│   │   ├── swapController.js      # Swap management
│   │   └── workflow.js            # Business workflows
│   ├── middlewares/
...
│   │   ├── Item.js                # Item schema
│   │   ├── PointRedemption.js     # Redemption records
│   │   ├── SwapRequest.js         # Swap requests schema
│   │   └── User.js                # User schema
│   ├── routes/
...
│   │   ├── redeemRoutes.js        # Redemption routes
│   │   ├── swapRoutes.js          # Swap routes
│   │   └── workflowRoute.js       # Workflow routes
│   ├── utils/
│   │   └── sendWelcomeEmails.js   # Email utilities
│   ├── app.js                     # Express app entry point
│   ├── Dockerfile                 # Backend Docker config
│   ├── package.json               # Backend dependencies
│   └── .env                       # Environment variables
│
├── hackathon-frontend/             # React + TypeScript Frontend
│   ├── src/
│   │   ├── components/
